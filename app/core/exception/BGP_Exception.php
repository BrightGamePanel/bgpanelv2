...
/**
 * Class BGP_Exception
 * Wrap HTTP error codes and messages as Exceptions
...
class BGP_Exception extends Exception {
    ...
    public static function httpHeaderFor($code) {
        if (array_key_exists($code, self::$messages)) {
            ...
            return 'HTTP/1.1 ' . self::$messages[ 404 ];
        }
    }
    ...
    /**
     * Send HTTP Header from the Exception Code
     */
    public function sendHeader() {
        header(self::httpHeaderFor($this->getCode()));
    }
}
